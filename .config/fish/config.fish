...
function fish_prompt
  ...
  if not set -q __fish_prompt_char
	...
	set -g __fish_prompt_char '#'
      case '*'
	set -g __fish_prompt_char (set_color c27dbf; echo λ)
    end
  end
...
#fi
  ...
  set -l hotpink (set_color c27dbf)
  ...
  # Line 1
  echo -n $white'╭─'$hotpink$current_user$white' at '$purple$__fish_prompt_hostname$white' in '$limegreen(pwd|sed "s=$HOME=⌁=")$turquoise
  __fish_git_prompt " (%s)"
  echo
